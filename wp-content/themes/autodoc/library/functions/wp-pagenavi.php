...
function wp_pagenavi($before = '', $after = '') {
	...
	$pagenavi_options = array(
		...
		'next_text' => __('','PixTheme'),
		'prev_text' => __('','PixTheme'),
...
function pagenavi_init() {
	...
	$pagenavi_options = array(
		...
		'current_text' => '%PAGE_NUMBER%',
		'page_text' => '%PAGE_NUMBER%',
		'first_text' => __('','PixTheme'),
		'last_text' => __('','PixTheme'),
		'next_text' => __('1','PixTheme'),
		'prev_text' => __('<span class="icon-chevron-left"></span>','PixTheme'),
		'dotright_text' => __('...','PixTheme'),
		'dotleft_text' => __('...','PixTheme'),
		'style' => 1,
		'num_pages' => 5, 
		'always_show' => 0,
		'num_larger_page_numbers' => 3,
