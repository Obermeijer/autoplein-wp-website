  ...
  <div class="container">
    <div class="row"> 
      ...
      <?php endif?>
       ...
       <div class="col-xs-12   <?php if ($layout == '3'):?> col-sm-9 col-md-9  <?php endif?>   <?php if ($layout == '2'):?>  col-sm-9 col-md-9  <?php endif?>  <?php if ($layout == '1'):?>  col-sm-12 col-md-12  <?php endif?>">  
